...
describe(':terminal buffer', function()
  ...
  it('supports OSC7 with autochdir', function()
    exec_lua([[
      ...
      vim.g.osc7_expected = parent:match("^(.+)/")
      vim.g.osc7_actual = vim.fn.getcwd():gsub("\\", "/")
    ]])
    eq(eval('g:osc7_expected'), eval("g:osc7_actual"))
  end)
end)
